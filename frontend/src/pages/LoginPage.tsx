      ...
      <div className="flex flex-1 flex-col justify-center px-6 py-10 md:px-16">
        <div className="pb-10">
          <div className="mb-6 flex items-center gap-3">
            ...
            <span className="text-xl font-semibold text-zinc-100">Release Notes</span>
          </div>
          <h1 className="mb-3 text-2xl font-semibold tracking-tight text-zinc-50 sm:text-4xl">
        ...
        <div className="flex items-center gap-4">
          <button
            onClick={startOAuth}
            disabled={busy}
            className="inline-flex items-center gap-2 rounded-lg bg-brand-600 px-5 py-2.5 text-sm font-medium text-white shadow-[0_0_24px_rgba(245,158,11,0.25)] hover:bg-brand-500 disabled:opacity-50"
          >
        ...
        {error && (
          <p role="alert" className="mt-4 max-w-md rounded-lg border border-red-500/40 bg-red-500/10 px-4 py-2.5 text-sm text-red-300">
            {error}
          </p>
        )}
      </div>
      <div className="hidden flex-1 items-center justify-center bg-gradient-to-br from-brand-600/15 via-transparent to-brand-500/10 lg:flex">
